  ...
  if (isSubmitted) {
    return (
      <div class="min-h-screen flex items-center justify-center bg-linear-to-tr from-[#FF4D4D] via-[#FFD700] to-[#4DFFBC] p-6">
        <div class="w-full max-w-md bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-xl text-center space-y-6 border border-white/20">
          ...
          <Link
            to="/login"
            class="inline-block w-full py-3.5 rounded-xl text-white font-bold bg-[#444] hover:bg-[#222] transition-colors"
          >
            Go to Login
          </Link>
          <button
            onClick={cancelSubmit}
            class="w-full py-3 rounded-xl text-gray-600 font-semibold border border-gray-300 hover:bg-gray-100 transition-colors"
          >
            Wrong email? Go back
          </button>
        </div>
  ...
  return (
    <div class="min-h-screen flex items-center justify-center bg-linear-to-tr from-[#FF4D4D] via-[#FFD700] to-[#4DFFBC] p-6">
      ...
      >
        ...
        <button
          type="submit"
          class="relative w-full overflow-hidden group font-bold py-3.5 rounded-xl text-white bg-[#444] transition-all hover: cursor-pointer"
        >
        ...
        <p class="text-center text-sm text-gray-600">
          ...
          <Link to="/login" class="text-[#FF4D4D] font-bold hover:underline">
            Log in here
          </Link>
        </p>
      </form>
